...
RSpec.describe Ai::ModelRegistry do
  it "parses the transcribe chain and resolves every named provider" do
  ...
  it "resolves Gemini and OpenRouter adapters" do
  ...
  it "truncates a chain by the fallback cap and honours a settings override" do
