  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed inset-x-0 bottom-0 z-[var(--z-sheet)] rounded-t-[var(--radius-xl)] bg-[var(--surface-panel)] pb-[var(--safe-area-bottom)] shadow-[var(--elevation-3)] ui-sheet",
          className,
        )}
        {...props}
      >
        ...
        <div className="px-[var(--control-pad-x)] py-[var(--control-pad-x)]">{children}</div>
