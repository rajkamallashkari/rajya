...
export interface paths {
    ...
    "/api/v1/admin/reports/{id}": {
        ...
        /** Show a report with subject context */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/admin/sticker_packs/{sticker_pack_id}/stickers": {
        ...
        get?: never;
        put?: never;
        /** Add a sticker to a system pack */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/admin/sticker_packs/{sticker_pack_id}/stickers/{id}": {
        ...
        put?: never;
        post?: never;
        /** Remove a sticker from a system pack */
        delete: {
            parameters: {
                query?: never;
                header?: never;
        ...
        post: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["SuggestReplies"];
                    };
                };
            };
        };
    ...
    "/api/v1/conversations/{id}/summarize": {
        ...
        get?: never;
        put?: never;
        /** Summarize unread or recent messages */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/conversations/{id}/generations/cancel": {
        ...
        get?: never;
        put?: never;
        /** Cancel an in-flight bot generation */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/api/v1/bot_requests": {
        ...
        /** List the current account's bot proposals */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["BotRequestList"];
                    };
                };
            };
        };
    ...
    "/api/v1/ai/rewrite": {
        ...
        post: {
            ...
            responses: {
                /** @description rewritten with conversation context */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/style_profile": {
        ...
        /** Show style-profile consent and blob */
        get: {
            parameters: {
                query?: never;
                header?: never;
        ...
        put?: never;
        /** Build the style profile after opt-in (F-11) */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                /** @description refused while consent is off */
                403: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        options?: never;
        head?: never;
        /** Set style-profile consent (F-11) */
        patch: {
            parameters: {
                query?: never;
                header?: never;
...
export interface components {
    schemas: {
        ...
        AdminReportSubject: {
            /** @enum {string} */
            type: "message" | "account" | "conversation" | "bot";
            id: number;
            label: string;
            body?: string | null;
            conversation_id?: number | null;
        ...
        AdminReport: {
            ...
            /** Format: date-time */
            created_at: string;
            reporter: components["schemas"]["Account"];
            subject: components["schemas"]["AdminReportSubject"];
        };
        AdminReportList: {
        ...
        BotRequestList: {
            bot_requests: components["schemas"]["BotRequest"][];
        };
        ContactNickname: {
            nickname: string;
            account: components["schemas"]["Account"];
