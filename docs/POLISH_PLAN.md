...
| **15.3** | Send-arrow menu: attach opens the existing picker and chips; schedule opens the existing schedule bar. Both actually send. Rewrite and silent stay. Do not change DS-13. | POLISH_TARGET §2; POLISH_AUDIT §2 | `legacy/botverse/src/components/chat/ChatInput.tsx` attach/schedule |
